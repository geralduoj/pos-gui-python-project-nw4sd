...
def main_window():
    ...
    def payBTN():
        ...
        def delivery():
            payatdoor = Tk()
            payatdoor.title("Delivery")
            payatdoor.geometry("500x500+0+0")
            patdlabel1 = Label(payatdoor, text="Enter your Shipping Address", font=('arial', 15,'bold'))
            patdlabel1.grid(row=0,column=0)
            

            patdlabel2 = Label(payatdoor, text="Contact Name ",justify=LEFT, anchor="w")
            patdlabel2.grid(row=1,column=0,columnspan=1,sticky = W)
            patdlabel3 = Label(payatdoor, text="Address Line 1 ",justify=LEFT, anchor="w")
            patdlabel3.grid(row=3,column=0,sticky = W)
            patdlabel4 = Label(payatdoor, text="Address Line 2 (optional) ",justify=LEFT, anchor="w")
            patdlabel4.grid(row=5,column=0,sticky = W)
            patdlabel5 = Label(payatdoor, text="City",justify=LEFT, anchor="w")
            patdlabel5.grid(row=7,column=0,sticky = W)
            patdlabel6 = Label(payatdoor, text="State/Province/Region ",justify=LEFT, anchor="w")
            patdlabel6.grid(row=9,column=0,sticky = W)
            patdlabel6 = Label(payatdoor, text="Postal Code/ZIP ",justify=LEFT, anchor="w")
            patdlabel6.grid(row=11,column=0,sticky = W)
            patdlabel6 = Label(payatdoor, text="Phone Number ",justify=LEFT, anchor="w")
            patdlabel6.grid(row=13,column=0,sticky = W)
            patdlabel6 = Label(payatdoor, text="Delivery Instructions ",justify=LEFT, anchor="w")
            patdlabel6.grid(row=15,column=0,sticky = W)

            shipBTN=Button(payatdoor, text="Ship!", bg="red", fg="white",padx=25,pady=10, font="bold, 15",command=lambda:[calculateQTY(),payatdoor.destroy()])
            shipBTN.grid(row=17,column=0)
            
            e1 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e1.grid(row=2, column=0)
            e2 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e2.grid(row=4, column=0)
            e3 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e3.grid(row=6, column=0)
            e4 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e4.grid(row=8, column=0)
            e5 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e5.grid(row=10, column=0)
            e6 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e6.grid(row=12, column=0)
            e7 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e7.grid(row=14, column=0)
            e8 = Entry(payatdoor, width=70, fg="black", bg="white", borderwidth=5)
            e8.grid(row=16, column=0)

        def cash():
            cashpay = Tk()
            cashpay.title("Cash Payment")
            cashpay.geometry("340x125")
            patd = Button(cashpay, text='Pay at Door', padx=50, pady=50, command=lambda:[delivery(),cashpay.destroy(),payment.destroy()])
            patd.grid(row=0,column=0)
            patd = Button(cashpay, text='Pay at Store', padx=50,pady=50, command=lambda:[cashpay.destroy(),payment.destroy(),calculateQTY()])
        ...
        def debit():
            ...
            root=Tk()
            root.title("Debit")
            paybutton = Button(root, text="Pay!", padx=20, fg="white", bg="red", command=lambda:[calculateQTY(), root.destroy(), payment.destroy()])
        ...
        cashBTN = Button(optionsFrame, text="CASH",padx=10,pady=10,command=lambda:[cash(), payment.destroy()])
        cashBTN.grid(row=0,column=0)
        creditBTN = Button(optionsFrame, text="Credit",padx=10,pady=10,command=lambda:[credit(),payment.destroy()])
        creditBTN.grid(row=0,column=1)
        debitBTN = Button(optionsFrame, text="Debit",padx=10,pady=10,command=lambda:[debit(),payment.destroy()])
        debitBTN.grid(row=0,column=2)
        gcBTN = Button(optionsFrame, text="Gift Card",padx=10,pady=10,command=lambda:[giftcard(),payment.destroy()])
